...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Bilge Adam - Pet Clinic Rest Api",
                "Örnek kullanıcı: ROLE_ADMIN -> serkan@mail.com, 12 => ROLE_SEKRETER -> erkan@mail.com, 1",
                "API 1.0",
                "Terms of service",
                new Contact("Pet Clinic", "www.example.com", "ali@company.com"),
